...
OUTPUT_DATA_FOLDER="$PROJECT_FOLDER"/output_nonpooled_rabt_blastx_ensemlbe_gtf_mouse"_"$RUN_ID
...
COMB_GTF=/home/groups/simons/Joe/rabt_blast_project_mm/input_data/RPKM/rabt_not_pooled_output/A30C_w_rpkm_counts.gtf
################# A30C_intERgenic ###########################
...
# FC30C
# TODO make sure the below input files are correct
COMB_GTF=/home/groups/simons/Joe/rabt_blast_project_mm/input_data/RPKM/rabt_not_pooled_output/FC30C_w_rpkm_counts.gtf
################# FC30C_intERgenic ###########################
# set grep var to find intERgenic exons
GREP_VAR='class_code "u"'
# set file prefix to name files as intRAgenic
...
# H30C
# TODO make sure the below input files are correct
COMB_GTF=/home/groups/simons/Joe/rabt_blast_project_mm/input_data/RPKM/rabt_not_pooled_output/H30C_w_rpkm_counts.gtf
################# H30C_intERgenic ###########################
# set grep var to find intERgenic exons
GREP_VAR='class_code "u"'
# set file prefix to name files as intRAgenic
